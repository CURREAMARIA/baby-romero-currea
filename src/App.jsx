...
const CLOTHING_DEFAULT = {
  ...
  "6-9m": {
    ...
    packages: [
      ...
      { id:"rC02", type:"Bodies manga corta", n:1, qty:"×3 uds",
...
const ITEMS_DEFAULT = [
  ...
  { id:"l1",cat:"lactancia",icon:"🥛",name:"Extractor de leche",detail:"para mamá — ideal entre 2",priority:"Alta",canSplit:true,
    specs:"Extractor de leche para mamá. Preferiblemente eléctrico.\n\nEl enlace de referencia es el modelo sugerido.",
    refLink:"https://a.co/d/01de44hF",claimedBy:[]},
  { id:"l2",cat:"lactancia",icon:"🧣",name:"Baberos muselina y Trapitos sacar gases · Pack 2",detail:"×10 uds",priority:"Alta",canSplit:false,
    specs:"Baberos y trapitos para gases suaves de muselina. Lavables y absorbentes. Sin botones que puedan soltarse.",
