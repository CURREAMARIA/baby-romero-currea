...
const ITEMS_DEFAULT = [
  ...
  { id:"b2",cat:"bano",icon:"🌿",name:"Toallas con capota",detail:"×2 uds",priority:"Alta",canSplit:false,
    ...
    refLink:"",claimedBy:[]},
  { id:"b3",cat:"bano",icon:"🧴",name:"Kit de aseo completo",detail:"todo en uno — ideal entre 2",priority:"Alta",canSplit:true,
  ...
  { id:"p2",cat:"panales",icon:"🥚",name:"Pañales desechables Etapa 1",detail:"×1 paquete · aprox. 3–6 kg",priority:"Alta",canSplit:false,
    specs:"Pañales desechables talla/etapa 1 (aprox. 3–6 kg). Cualquier marca de confianza. Para los primeros meses.",
    refLink:"",claimedBy:[]},
  { id:"p3",cat:"panales",icon:"🦕",name:"Pañales desechables Etapa 2",detail:"×1 paquete · aprox. 4–8 kg",priority:"Media",canSplit:false,
    specs:"Pañales desechables talla/etapa 2 (aprox. 4–8 kg). Cualquier marca de confianza.",
    refLink:"",claimedBy:[]},
  { id:"p4",cat:"panales",icon:"🦖",name:"Pañales desechables Etapa 3",detail:"×1 paquete · aprox. 6–11 kg",priority:"Media",canSplit:false,
    specs:"Pañales desechables talla/etapa 3 (aprox. 6–11 kg). Cualquier marca de confianza.",
    refLink:"",claimedBy:[]},
  { id:"p5",cat:"panales",icon:"🌿",name:"Pañales desechables Etapa 4",detail:"×1 paquete · aprox. 9–14 kg",priority:"Media",canSplit:false,
    specs:"Pañales desechables talla/etapa 4 (aprox. 9–14 kg). Cualquier marca.",
    refLink:"",claimedBy:[]},
  ...
  { id:"l2",cat:"lactancia",icon:"🧣",name:"Baberos muselina · Pack 2",detail:"×4 uds",priority:"Alta",canSplit:false,
    specs:"Igual que Pack 1. Para completar 8 unidades en total.",
    refLink:"https://a.co/d/00BFZfhz",claimedBy:[]},
  { id:"l3",cat:"lactancia",icon:"🌿",name:"Trapitos sacar gases",detail:"×5 uds",priority:"Alta",canSplit:false,
    specs:"En algodón o muselina. Muy útiles durante la lactancia. Suaves y lavables.",
    refLink:"",claimedBy:[]},
  { id:"l4",cat:"lactancia",icon:"🍼",name:"Biberones Pigeon ×3",detail:"⚠️ marca específica",priority:"Alta",canSplit:false,
    specs:"⚠️ MARCA ESPECÍFICA: Pigeon\n\nBusca biberones PIGEON para recién nacido (flujo lento / newborn flow). Los encuentras en tiendas de bebés, Falabella, Rappi o Amazon Colombia.\n\n🚫 Por favor no sustituir por otra marca — es importante para la preferencia del bebé.",
    refLink:"",claimedBy:[]},
  { id:"l5",cat:"lactancia",icon:"🤱",name:"Cojín de lactancia",detail:"ergonómico, lavable",priority:"Alta",canSplit:true,
  ...
  { id:"s2",cat:"sueno",icon:"🌿",name:"Sábanas ajustables ×3",detail:"para cuna colecho",priority:"Alta",canSplit:false,
    specs:"⚠️ Verificar la medida exacta del colecho antes de comprar para que ajusten bien.",
    refLink:"",claimedBy:[]},
  { id:"s3",cat:"sueno",icon:"🧸",name:"Mantas de muselina ×4",detail:"suaves y versátiles",priority:"Alta",canSplit:false,
    specs:"Para cubrir, cargar o usar en lactancia. De algodón o bambú.",
    refLink:"",claimedBy:[]},
  ...
  { id:"s7",cat:"sueno",icon:"🪑",name:"Silla vibradora y mecedora",detail:"para calmar y relajar al bebé · ideal entre 2",priority:"Alta",canSplit:true,
    ...
    <>
      ...
      <div style={{maxWidth:640,margin:"0 auto",padding:"18px 14px 80px"}}>
        ...
        <div style={{textAlign:"center",marginTop:18,fontSize:13,color:"#6ee7b7",fontWeight:700}}>
          🦖 Hecho con amor para Baby Romero Currea 🦕
        </div>
      </div>
    </>
  );
