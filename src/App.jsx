...
const CLOTHING_DEFAULT = {
  "0-3m": {
    ...
    packages: [
      ...
      { id:"rA04", type:"Pijamas algodón", n:1, qty:"×6 uds",
      ...
      { id:"rA05", type:"Pijamas algodón", n:2, qty:"×6 uds",
        specs:"Preferiblemente con broches a presión en la entrepierna. Sin cordones ni cremalleras. Talla 0-3 meses", refLink:"", claimedBy:"" },
    ],
  },
  "3-6m": {
    ...
    packages: [
      ...
      { id:"rB04", type:"Pijamas algodón", n:1, qty:"×6 uds",
      ...
      { id:"rB07", type:"Ropa para salir", n:2, qty:"×3 mudas",
        specs:"Mudas completas para salir. Pueden ser conjuntos. Talla 3-6 meses. Diferentes estilos/colores.", refLink:"", claimedBy:"" },
    ],
  },
  "6-9m": {
    ...
    packages: [
      ...
      { id:"rC02", type:"Bodies manga larga", n:2, qty:"×6 uds",
        specs:"Algodón preferiblemente. Colores neutros. Talla 6-9 meses.", refLink:"", claimedBy:"" },
  ...
  "9-12m": {
    ...
    packages: [
      { id:"rD01", type:"Bodies manga larga", n:1, qty:"×6 uds",
        specs:"Algodón preferiblemente. Talla 9-12 meses.", refLink:"", claimedBy:"" },
      { id:"rD02", type:"Bodies manga larga", n:2, qty:"×6 uds",
        specs:"Igual que Paquete 1. Talla 9-12 meses.", refLink:"", claimedBy:"" },
      { id:"rD03", type:"Bodies manga corta", n:1, qty:"×6 uds",
...
const ITEMS_DEFAULT = [
  ...
  { id:"p6",cat:"panales",icon:"🧳",name:"Cambiador portátil y pañitos humedos",detail:"para salidas",priority:"Alta",canSplit:false,
    specs:"Plegable, fácil de limpiar. Con bolsillos si es posible. Para cambio fuera de casa y exteriores. Pañitos humedos sin alcohol ni perfume (entre más cantidad, mejor — varios paquetes grandes)",
    refLink:"https://a.co/d/0dg1ibJ0",claimedBy:[]},
  // LACTANCIA
  ...
  { id:"l8",cat:"lactancia",icon:"🍼",name:"Bolsas Almacenamiento Leche",detail:"Bolsas Almacenamiento Leche Materna",priority:"Media",canSplit:false,
    specs:"Preferiblemente pack x120, ideales para el banco de leche del bebé",
  ...
  { id:"s5",cat:"sueno",icon:"🌙",name:"Cobijita liviana ×2",detail:"suave y transpirable",priority:"Media",canSplit:false,
    specs:"⚠️ Para el coche, salidas o noches de frio.",
    refLink:"",claimedBy:[]},
  ...
  { id:"t3",cat:"paseo",icon:"🚼",name:"Coche/cochecito",detail:"seguro para RN · ideal entre 2",priority:"Alta",canSplit:true,
    ...
    refLink:"https://www.babycentro.com/products/coche-bebesit-galaxy-premium-travel-system-negro-3-en-1",claimedBy:[]},
