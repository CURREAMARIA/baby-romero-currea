...
const CLOTHING_DEFAULT = {
  "0-3m": {
    ...
    packages: [
      ...
      { id:"rA04", type:"Pijamas algodón", n:2, qty:"×3 uds",
  ...
  "3-6m": {
    ...
    packages: [
      ...
      { id:"rB06", type:"Ropa para salir", n:2, qty:"×3 mudas",
...
const ITEMS_DEFAULT = [
  ...
  { id:"l3",cat:"lactancia",icon:"🍼",name:"Biberones Pigeon ×3",detail:"⚠️ marca específica",priority:"Alta",canSplit:false,
    ...
    refLink:"",claimedBy:[]},
  { id:"l4",cat:"lactancia",icon:"🤱",name:"Cojín de lactancia",detail:"ergonómico, lavable",priority:"Alta",canSplit:true,
    specs:"Cojín ergonómico y lavable para lactancia. Cualquier color o diseño.",
    refLink:"",claimedBy:[]},
  { id:"l5",cat:"lactancia",icon:"🍽️",name:"Kit de comer (6 meses+)",detail:"plato, cucharas, vaso",priority:"Media",canSplit:false,
    ...
    refLink:"",claimedBy:[]},
  { id:"l6",cat:"lactancia",icon:"🍼",name:"Bolsas Almacenamiento Leche",detail:"Bolsas Almacenamiento Leche Materna",priority:"Media",canSplit:false,
  ...
  { id:"s2",cat:"sueno",icon:"🌿",name:"Sábanas ajustables y mantas de muselina ×3",detail:"para cuna colecho",priority:"Alta",canSplit:false,
    ...
    refLink:"",claimedBy:[]},
   { id:"s3",cat:"sueno",icon:"💤",name:"Saco de dormir bebé",detail:"más seguro que cobijas",priority:"Media",canSplit:false,
    specs:"Más seguro que cobijas sueltas. Liviano, de talla adecuada para recién nacido.",
    refLink:"",claimedBy:[]},
  { id:"s4",cat:"sueno",icon:"🌙",name:"Cobijita liviana ×2",detail:"suave y transpirable",priority:"Media",canSplit:false,
    specs:"⚠️ No dejar suelta en el espacio de sueño del recién nacido.",
    refLink:"",claimedBy:[]},
  { id:"s5",cat:"sueno",icon:"🔴",name:"Máquina ruido blanco + luz roja",detail:"para que duerma mejor · ideal entre 2",priority:"Alta",canSplit:true,
  ...
  { id:"s6",cat:"sueno",icon:"🪑",name:"Silla vibradora y mecedora",detail:"para calmar y relajar al bebé",priority:"Alta",canSplit:false,
  ...
  // FUTURO
  { id:"f1",cat:"futuro",icon:"🎡",name:"Gimnasio para bebé",detail:"con juguetes colgantes",priority:"Media",canSplit:false,
    specs:"Con arco y juguetes colgantes para estimulación visual, auditiva y motora. Puede incluir espejo, sonajeros y texturas.",
    refLink:"",claimedBy:[]},
  { id:"f2",cat:"futuro",icon:"🪑",name:"Silla comedor bebé",detail:"6 meses+ · ideal entre 2",priority:"Media",canSplit:true,
  ...
  { id:"f3",cat:"futuro",icon:"🚽",name:"Bacinilla 3 en 1",detail:"12 meses en adelante",priority:"Baja",canSplit:false,
  ...
  { id:"f4",cat:"futuro",icon:"🚶",name:"Andador",detail:"para empezar a caminar",priority:"Baja",canSplit:false,
    specs:"Andador para la etapa de aprendizaje de caminar.\n\nEl enlace de referencia es el modelo sugerido.",
    refLink:"https://a.co/d/0dtwIiN9",claimedBy:[]},
  { id:"f5",cat:"futuro",icon:"🚶",name:"Papá de repuesto",detail:"para cuando esté cansado el oficial",priority:"Alta",canSplit:false,
