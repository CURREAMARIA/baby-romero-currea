...
const ITEMS_DEFAULT = [
  ...
  { id:"l2",cat:"lactancia",icon:"🧣",name:"Baberos muselina · Pack 1",detail:"×4 uds",priority:"Alta",canSplit:false,
  ...
  { id:"l3",cat:"lactancia",icon:"🧣",name:"Baberos muselina · Pack 2",detail:"×4 uds",priority:"Alta",canSplit:false,
    specs:"Igual que Pack 1. Para completar 8 unidades en total.",
    refLink:"https://a.co/d/00BFZfhz",claimedBy:[]},
  { id:"l4",cat:"lactancia",icon:"🌿",name:"Trapitos sacar gases",detail:"×5 uds",priority:"Alta",canSplit:false,
